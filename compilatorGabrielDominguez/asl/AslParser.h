...
public:
  ...
  enum {
    ...
    RuleArray_type = 8, RuleTuple_type = 9, RuleStatements = 10, RuleStatement = 11, 
    RuleLeft_expr = 12, RuleExpr = 13, RuleValues = 14, RuleIdent = 15
  };
  ...
  class  FunctionIdentContext : public ExprContext {
  public:
    FunctionIdentContext(ExprContext *ctx);
