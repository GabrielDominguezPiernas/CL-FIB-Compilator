...
public:
  ...
  virtual antlrcpp::Any visitParameter(AslParser::ParameterContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitTuple_type(AslParser::Tuple_typeContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitTuple(AslParser::TupleContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitFunctionIdent(AslParser::FunctionIdentContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitValues(AslParser::ValuesContext *ctx) override {
    return visitChildren(ctx);
  }
