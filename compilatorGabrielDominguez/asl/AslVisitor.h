...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitParameter(AslParser::ParameterContext *context) = 0;
    ...
    virtual antlrcpp::Any visitTuple_type(AslParser::Tuple_typeContext *context) = 0;
    ...
    virtual antlrcpp::Any visitTuple(AslParser::TupleContext *context) = 0;

    virtual antlrcpp::Any visitFunctionIdent(AslParser::FunctionIdentContext *context) = 0;
    ...
    virtual antlrcpp::Any visitValues(AslParser::ValuesContext *context) = 0;
