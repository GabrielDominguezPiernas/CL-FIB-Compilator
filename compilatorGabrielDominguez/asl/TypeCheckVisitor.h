...
public:
  ...
  antlrcpp::Any visitFunctionIdent(AslParser::FunctionIdentContext *ctx);
  ...
  //antlrcpp::Any visitPackStmt(AslParser::PackStmtContext *ctx);
  //antlrcpp::Any visitUnpackStmt(AslParser::UnpackStmtContext *ctx);
  //antlrcpp::Any visitMapStmt(AslParser::MapStmtContext *ctx);
  //antlrcpp::Any visitMaxDot(AslParser::MaxDotContext *ctx);
  //antlrcpp::Any visitProdEscalar(AslParser::ProdEscalarContext *ctx);
  ...
  //antlrcpp::Any visitPotencia(AslParser::PotenciaContext *ctx);
